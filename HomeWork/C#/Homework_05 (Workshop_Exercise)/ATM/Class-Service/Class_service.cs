...
namespace ATM_Functions
{
    class Functions
    {

        public static void PrintUsers(User[] lsitOfUsers)
        {
            Console.WriteLine("The users are:");
            foreach (User person in lsitOfUsers)
            {
        ...
        public static long CheckCardNumber(User[] lsitOfUsers)
        {
            ...
            if (!checkInt)
            {
                ...
                randomNumber = CheckCardNumber(lsitOfUsers);
            }
            return randomNumber;
        }

        public static long CardNumberForLogin(User[] lsitOfUsers)
        {
            long check = 0;
            long cardNumber = CheckCardNumber(lsitOfUsers);
            ...
            if (check == 0)
            {
                ...
                Console.WriteLine("Please try again");
                check = CardNumberForLogin(lsitOfUsers);
            }
            return check;
        }

        public static long CardNumberForRegister(User[] lsitOfUsers)
        {
            ...
            if (check == 0)
            {
                ...
                check = CardNumberForRegister(lsitOfUsers);
            }
            return check;
        }

        public static string CheckCardPin(User[] lsitOfUsers)
        {
            string check = "";
            ...
            if (check == "")
            {
                ...
                Console.WriteLine("Please try again");
                check = CheckCardPin(lsitOfUsers);
            }
            return check;
        }
